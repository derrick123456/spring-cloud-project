...
import com.test.demo.user.config.NacosConfig;
import com.test.demo.user.model.CommonRsp;
import com.test.demo.user.model.page.PageResult;
import com.test.demo.user.model.dto.TestDto;
import com.test.demo.user.model.dto.TestModulePageDto;
import com.test.demo.user.model.entity.TestModuleManage;
import com.test.demo.user.service.ITestModuleManageService;
...
public class TestModuleManageController {
    ...
    public CommonRsp<TestModuleManage> info(@RequestParam(value = "id") String id) {
    ...
    public CommonRsp<String> test() {

        String str = "远程调用成功！" + "----------"  + "----------" + value+"-------------"+nacosConfig.toString();
        return MessageUtil.success(str);
    }
}
